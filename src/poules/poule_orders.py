# Order of bouts taken from Bout Order download on webpage: https://www.usafencing.org/scoresheets
POULE_BOUT_ORDER = {
    2: [(1,2)],
    3: [(1,2), (1,3), (2,3)],
...
"""Holds the bout orders for poules of sizes from 2 to 12. A match is represented by a tuple with the fencer on the right of the referee being the first number and the fencer on the left being the second number."""